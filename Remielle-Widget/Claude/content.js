// =============================================================
// Claude — Remielle the Widget · claude.ai
// =============================================================

// --- Widget size (persisted across sessions) ---
const SIZE_KEY  = 'remielle-size-claude';
const SIZE_MIN  = 60;
const SIZE_MAX  = 220;
const SIZE_STEP = 12;
...
// =============================================================
// Claude-specific selectors & State Machine
// =============================================================
...
function inspectElementState(el) {
  ...
  // 2. Response content check (broad selectors to handle UI updates)
...
function startAIObserver() {
  ...
  aiObserver = new MutationObserver((mutations) => {
    ...
    // --- State Transitions ---
    if (hasResponseText) {
      // Real answer text is streaming -> switch to AI_TYPING!
...
function setupUserDetection() {
  ...
  // Click on send button or any button in composer
  ...
  // Handles cases where click/keyboard events are bypassed or missed
  setInterval(() => {
